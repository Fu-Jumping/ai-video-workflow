  ...
  themeConfig: {
    ...
    sidebar: {
      "/en/": [
        ...
        { text: "Contributors", items: [{ text: "Repo Architecture", link: "/en/contributors/repo-architecture" }, { text: "Testing", link: "/en/contributors/testing" }, { text: "Release Process", link: "/en/contributors/release-process" }] }
      ],
      "/zh/": [
        ...
        { text: "贡献者", items: [{ text: "仓库架构", link: "/zh/contributors/repo-architecture" }, { text: "测试", link: "/zh/contributors/testing" }, { text: "发布流程", link: "/zh/contributors/release-process" }] }
      ]
    }
  }
});
