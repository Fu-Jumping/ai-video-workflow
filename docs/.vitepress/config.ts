...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      "/en/": [
        { text: "For Users", items: [{ text: "Home", link: "/en/" }, { text: "Beginner Agent Start", link: "/en/quickstart/beginner-agent-init" }, { text: "Quickstart", link: "/en/quickstart/index" }, { text: "Verify and Iterate", link: "/en/quickstart/verify-and-iterate" }] },
        { text: "Workflow", items: [{ text: "Overview", link: "/en/workflow/overview" }, { text: "Step 0", link: "/en/workflow/step-00-research" }, { text: "Step 1", link: "/en/workflow/step-01-concept" }, { text: "Step 2", link: "/en/workflow/step-02-setting" }, { text: "Step 3", link: "/en/workflow/step-03-storyboard" }, { text: "Step 4", link: "/en/workflow/step-04-image-prompts" }, { text: "Step 5", link: "/en/workflow/step-05-video-prompts" }, { text: "Step 6", link: "/en/workflow/step-06-execution-plan" }, { text: "Step 7", link: "/en/workflow/step-07-publish-materials" }, { text: "Impact Analysis", link: "/en/workflow/impact-analysis" }, { text: "Rewrite Handbook", link: "/en/workflow/rewrite-handbook" }, { text: "Supported Deviations", link: "/en/workflow/supported-deviations" }] },
      ...
      "/zh/": [
        { text: "给用户", items: [{ text: "首页", link: "/zh/" }, { text: "新手智能体启动", link: "/zh/quickstart/beginner-agent-init" }, { text: "快速开始", link: "/zh/quickstart/index" }, { text: "校验与迭代", link: "/zh/quickstart/verify-and-iterate" }] },
        { text: "工作流", items: [{ text: "总览", link: "/zh/workflow/overview" }, { text: "Step 0", link: "/zh/workflow/step-00-research" }, { text: "Step 1", link: "/zh/workflow/step-01-concept" }, { text: "Step 2", link: "/zh/workflow/step-02-setting" }, { text: "Step 3", link: "/zh/workflow/step-03-storyboard" }, { text: "Step 4", link: "/zh/workflow/step-04-image-prompts" }, { text: "Step 5", link: "/zh/workflow/step-05-video-prompts" }, { text: "Step 6", link: "/zh/workflow/step-06-execution-plan" }, { text: "Step 7", link: "/zh/workflow/step-07-publish-materials" }, { text: "影响面排查", link: "/zh/workflow/impact-analysis" }, { text: "源层重写手册", link: "/zh/workflow/rewrite-handbook" }, { text: "受支持偏离", link: "/zh/workflow/supported-deviations" }] },
